...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Olive Oak Interior Decor | Curtains, Blinds & Interior Décor Nairobi" },
      {
        name: "description",
        content:
      ...
      { property: "og:site_name", content: "Olive Oak Interior Decor" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description:
            "Curtains, blinds and interior décor solutions for homes, offices and hospitality spaces in Nairobi, Kenya.",
          telephone: "+254722270517",
          address: {
            "@type": "PostalAddress",
            streetAddress: "Old Mombasa Road",
